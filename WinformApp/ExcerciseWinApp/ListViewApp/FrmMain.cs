...
namespace ListViewApp
{
    public partial class FrmMain : Form
    {
        ...
        private void FrmMain_Load(object sender, EventArgs e)
        {
            ...
            itemDs.SubItems.Add("600,000");
            itemDs.SubItems.Add("10");
            itemDs.SubItems.Add("6,000,000");

            ListViewItem itemPs = new ListViewItem("PaltStation 4", 2);
            itemPs.SubItems.Add("300,000");
            itemPs.SubItems.Add("50");
            itemPs.SubItems.Add("15,000,000");

            ListViewItem itemWill = new ListViewItem("Nintendo Will", 3);
            itemWill.SubItems.Add("400,000");
            itemWill.SubItems.Add("10");
            itemWill.SubItems.Add("4,000,000");
            ...
            LsvProducts.Items.AddRange(new ListViewItem[] { itemSwitch, itemDs, itemPs, itemWill, itemXbox });
            //LsvProducts.Items.Add();
        }
